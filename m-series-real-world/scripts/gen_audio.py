#!/usr/bin/env python3
"""Builds both films' music bed, transition layer and silent VO placeholder.
...
ZONE = {
    "hook":    (0.95, 1.30, True),  "open":    (0.92, 1.28, True),
    "range":   (0.64, 1.06, False), "signal":  (0.76, 0.96, True),
    "gain":    (0.72, 0.90, True),  "latency": (0.86, 1.12, True),
    "monitor": (0.70, 1.00, True),  "m2":      (0.66, 1.04, False),
    "m4":      (0.74, 1.00, True),  "m6":      (0.90, 1.08, True),
    "room":    (0.92, 1.14, True),  "choose":  (0.80, 1.06, True),
    "close":   (0.62, 1.22, False),
}
...
CHAPTER_IMPACT = {
    "hook": "impact-deep",  "open": "impact-deep",   "range": "gate-snap",
    "signal": "chime-lift", "gain": "impact-tight",  "latency": "snap-hard",
    "monitor": "chime-hi",  "m2": "whip-soft",       "m4": "whip-mid",
    "m6": "impact-full",    "room": "impact-full",   "choose": "chime-lift",
    "close": "air-long",
}
...
summary = {}
all_cues = {}
for key, base in (("reel", "motu-m-series-reel"), ("video", "motu-m-series-explainer")):
    film = TL[key]
    N = int(film["total"] * SR)
