  ...
  BEATS.forEach((b, i) => {
    ...
    switch (b.kind) {
      ...
      case "macroReveal":
        ...
        if (b.id === "p4-macro") knobTurn(start + Math.round(len * 0.5));
        break;
      case "macroPair":
      ...
      case "software":
        ...
        break;
      case "heroSplit":
        if (b.id === "p4-mix") knobTurn(start + 26, 7, 0.14);
 ...
 *
 * Drop the recorded narration at `public/vo/voiceover-portrait.mp3` and flip
