...
MSER = ('/home/user/motu-m-series-m2-m4-m6-high-end-video-'
        'shivansh-electronics-kolkata')
NEU = ('/home/user/all-graphic-designs---shivansh-electronics-kolkata---'
       'html-codes/neumann-tlm-107')

# series -> (frames repo, ids file, brand-marks repo, manufacturer logo file)
PRODUCTS = {
    'ul5':  (UL,   'ul5.json',    UL,   'MOTU (Mark of the Unicorn) BRAND LOGO.png'),
    'm828': (UL,   'm828.json',   UL,   'MOTU (Mark of the Unicorn) BRAND LOGO.png'),
    'm16a': (AVB,  'm16a.json',   AVB,  'MOTU LOGO.png'),
    'm848': (AVB,  'm848.json',   AVB,  'MOTU LOGO.png'),
    'm10p': (AVB,  'm10p.json',   AVB,  'MOTU LOGO.png'),
    'm2':   (MSER, 'm2.json',     MSER, 'MOTU LOGO.png'),
    'm4':   (MSER, 'm4.json',     MSER, 'MOTU LOGO.png'),
    'm6':   (MSER, 'm6.json',     MSER, 'MOTU LOGO.png'),
    'tlm':  (NEU,  'tlm107.json', NEU,  'NEUMANN BERLIN LOGO.png'),
}
...
def main(series):
    root, idsf, brandroot, logofile = PRODUCTS[series]
    ...
    for s_, name in ((os.path.join(brandroot, logofile), 'logo_brand'),
