...
const NAME = "motu-m-series-longform";
...
cpSync(resolve(REPO, "_shared"), join(root, "_shared"), { recursive: true });
...
console.log(`     ${manifest.length} stills + 2 logos + 4 fonts + 5 reused sfx + 10 music stems vendored`);
