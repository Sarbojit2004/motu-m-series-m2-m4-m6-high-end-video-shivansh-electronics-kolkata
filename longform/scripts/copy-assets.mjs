...
// -------------------------------------------------------------------- music
const STEMS = {
  "mindscape-bass": "ES_Mindscape STEMS BASS - Lennon Hutton.mp3",
  "mindscape-instruments": "ES_Mindscape STEMS INSTRUMENTS - Lennon Hutton.mp3",
  "mindscape-melody": "ES_Mindscape STEMS MELODY - Lennon Hutton.mp3",
  ...
  "blackblue-bass": "ES_Black & Blue (Instrumental Version) STEMS BASS - Torii Wolf.mp3",
  "blackblue-drums": "ES_Black & Blue (Instrumental Version) STEMS DRUMS - Torii Wolf.mp3",
  "blackblue-instruments": "ES_Black & Blue (Instrumental Version) STEMS INSTRUMENTS - Torii Wolf.mp3",
};
...
writeFileSync(
  resolve(PUB, "vo/.keep"),
  "Drop the recorded narration here as voiceover-longform.mp3, then flip HAS_VOICEOVER in src/Audio.tsx.\n"
);
console.log("done.");
